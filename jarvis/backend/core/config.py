...
class Settings(BaseSettings):
    ...
    # --- Gateway (API server) ---
    # Host defaults to localhost-only for safety. To allow other devices
    # on your network (or via Tailscale) to reach it, set this to
    # "0.0.0.0" in .env — see docs/architecture.md for the tradeoffs.
    ...
    # as "Authorization: Bearer <token>". Required the moment the
    # gateway is reachable beyond localhost. Generate a long random
    # string — e.g. `python -c "import secrets; print(secrets.token_hex(32))"`
